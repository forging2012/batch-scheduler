package com.asofdate.dispatch.core;
...
public class ShellTasklet implements Tasklet {
    ...
    public ShellTasklet(String scriptFile, String basePath) {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        try {
            process = Runtime.getRuntime().exec(SHELL_PREFIX + " " + scritpFile + " " + jobParameters);
